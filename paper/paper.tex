...
\section{Features}
    ...
    The simplest illustration of a higher order function is trivial, but surprisingly neglected from any existing quantum language: it is the tensor operator, known to functional programmers as the higher-order function, \emph{map}.
