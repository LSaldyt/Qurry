...
\IEEEPARstart{P}{robabilistic} programming languages are a recent innovation from the MIT cognitive science community. 
...
Famously, this has resulted in dramatically reduced code complexity, with a famous case where a 50-line probabilistic program could compete with traditional approaches to face recognition [Cite].
In general, there is evidence to support that highly abstract and specialized languages such as this will be useful both in industry and in scientific research.
...
The simplest case is a Bell state, where, for instance, one may measure $00$ or $11$ with equal probability.
