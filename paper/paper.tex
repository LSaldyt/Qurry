...
\begin{itemize}
    \item SWAP ['q1', 'q2']
    \item ISWAP ['q1', 'q2']
    \item PSWAP ['angle', 'q1', 'q2']
\end{itemize}

\begin{itemize}
    \item PHASE ['angle', 'qubit']
    \item MEASURE ['qubit', 'classical\_reg']
    \item CZ ['control', 'target']
    \item CNOT ['control', 'target']
    \item CCNOT ['control1', 'control2', 'target']
    \item CPHASE00 ['angle', 'control', 'target']
    \item CPHASE01 ['angle', 'control', 'target']
    \item CPHASE10 ['angle', 'control', 'target']
    \item CPHASE ['angle', 'control', 'target']
...
\begin{itemize}
    \item TRUE ['classical\_reg']
    \item FALSE ['classical\_reg']
    \item NOT ['classical\_reg']
    \item AND ['classical\_reg1', 'classical\_reg2']
    \item OR ['classical\_reg1', 'classical\_reg2']
    \item MOVE ['classical\_reg1', 'classical\_reg2']
    \item EXCHANGE ['classical\_reg1', 'classical\_reg2']
    \item IOR ['classical\_reg1', 'classical\_reg2']
    \item XOR ['classical\_reg1', 'classical\_reg2']
    \item NEG ['classical\_reg']
    \item ADD ['classical\_reg', 'right']
    \item SUB ['classical\_reg', 'right']
    \item MUL ['classical\_reg', 'right']
    \item DIV ['classical\_reg', 'right']
    \item EQ ['classical\_reg1', 'classical\_reg2', 'classical\_reg3']
    \item GT ['classical\_reg1', 'classical\_reg2', 'classical\_reg3']
    \item GE ['classical\_reg1', 'classical\_reg2', 'classical\_reg3']
    \item LE ['classical\_reg1', 'classical\_reg2', 'classical\_reg3']
    \item LT ['classical\_reg1', 'classical\_reg2', 'classical\_reg3']
